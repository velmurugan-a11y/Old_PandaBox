#!/usr/bin/env bash
# Build 03_PandaBox_BLE_LCR with the Arm GNU toolchain (arm-none-eabi-gcc must be on PATH).
set -e
...
SRCS="src/main.c src/board.c src/uart.c src/bt.c src/bt_init_table.c src/proto.c src/lcr_host.c src/meter.c src/lcp.c src/system_gd32f30x.c \
  $SPL/Source/gd32f30x_rcu.c $SPL/Source/gd32f30x_gpio.c $SPL/Source/gd32f30x_misc.c $SPL/Source/gd32f30x_usart.c  \
